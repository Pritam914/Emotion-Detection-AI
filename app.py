...
def setup_resources():
    ...
    # Exact filename matching your GitHub repo
...
if option == "Home":
    st.write("### Welcome Pritam! Use the sidebar to start.")
    st.info("Live Webcam feature uses WebRTC for cloud compatibility.")

elif option == "Live Webcam":
    st.write("### 🎥 Live Stream")
    webrtc_streamer(key="emotion-detect", video_transformer_factory=EmotionTransformer)
